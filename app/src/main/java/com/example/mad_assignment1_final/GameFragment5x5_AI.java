...
public class GameFragment5x5_AI extends Fragment implements  View.OnClickListener {

    List<ImageView> tileList;
    boolean playerCanMove = true;

    boolean x_turn = true;
    boolean AI_mode = true; // Add this line to denote if AI mode is on
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.game_fragment5x5, container, false);
        ...
        btnSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GameFragment5x5_AI gameFragment = (GameFragment5x5_AI) getActivity().getSupportFragmentManager().findFragmentByTag("GAME_FRAGMENT_TAG");
                if (gameFragment != null) {
                    transaction.hide(gameFragment);
                }
                InGameMenuFragment inmenuFragment = new InGameMenuFragment();
                inmenuFragment.setFragmentToResumeTag("GAME_FRAGMENT_TAG_5x5_AI");
