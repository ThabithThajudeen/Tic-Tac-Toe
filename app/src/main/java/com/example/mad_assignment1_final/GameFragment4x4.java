...
public class GameFragment4x4 extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int layoutId = (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE)
                ? R.layout.game_fragment4x4_land
                : R.layout.game_fragment4x4;
        ...
        btnSettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GameFragment4x4 gameFragment = (GameFragment4x4) getActivity().getSupportFragmentManager().findFragmentByTag("GAME_FRAGMENT_TAG");
                if (gameFragment != null) {
                    transaction.hide(gameFragment);
                }
                InGameMenuFragment inmenuFragment = new InGameMenuFragment();
                inmenuFragment.setFragmentToResumeTag("GAME_FRAGMENT_TAG_4x4");
